...
dependencies {
    ...
    implementation(project(":feature-mock-location"))
    implementation(project(":feature-network-log"))
    implementation(project(":feature-readability"))
    ...
    implementation(project(":feature-keyboard-scroll"))
