...
/**
 * readability.js を埋め込んだ javascript: URI を生成する。
 * テスト可能なようにトップレベル関数として定義。
 */
internal fun buildReadabilityScript(readabilityJs: String): String {
...
internal class ReadabilitySimpleView(
    ...
    internal fun buildScript(readabilityJs: String): String = buildReadabilityScript(readabilityJs)
}
