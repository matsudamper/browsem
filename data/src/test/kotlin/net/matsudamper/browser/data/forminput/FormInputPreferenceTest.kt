...
class FormInputPreferenceTest {
    ...
    @Test
    fun deleteLastFieldWithValueKeepsEnabledFieldWithoutValue() = runBlocking {
        val page = FormInputPageKey(
            scheme = "https",
            host = "example.com",
            port = 443,
        ...
        assertTrue(repository.getFieldEnabled(origin, "/form", "memo"))
    }
